...
public class Filme implements Serializable, Comparable<Filme> {
    ...
    public Filme(String fNome, LocalDate fData, String fLocal) {
        this.fNome = fNome;
        this.fData = fData;
        this.fLocal = fLocal;
        fComentarios = "";
    ...
    public Filme(String fNome, int fDia, int fMes, int fAno, String fLocal, String fComentarios) {
        this.fNome = fNome;
    ...
    public Filme(String fNome, LocalDate fData, String fLocal, String fComentarios) {
        this.fNome = fNome;
        this.fData = fData;
        this.fLocal = fLocal;
        this.fComentarios = fComentarios;
