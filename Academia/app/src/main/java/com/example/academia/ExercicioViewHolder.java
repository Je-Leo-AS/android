...
public class ExercicioViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
{
    ImageView fCartaz;
    TextView fNome;
    TextView fDataLocal;
    ...
    public FilmeViewHolder(@NonNull View itemView, ExercicioAdapter adapter, Context context) {
        super(itemView);
